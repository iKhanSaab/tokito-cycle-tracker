    ...
    <div className="min-h-screen bg-background pb-24">
      <div className="max-w-md mx-auto p-4 space-y-6">
        ...
        <Section title="Reminders">
          <div className="space-y-3">
            {([
              { key: 'wakeup' as const, label: 'Wakeup reminder' },
              { key: 'daytime' as const, label: 'Daytime snapshot' },
              { key: 'evening' as const, label: 'Evening deep log' },
              { key: 'nudge' as const, label: 'Daily nudge' },
            ]).map((r) => (
